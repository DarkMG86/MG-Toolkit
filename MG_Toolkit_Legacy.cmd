...
:: Contrôle des prerequis (minimum Windows XP et maximum Windows 8.1 ainsi que la presence de PowerShell)
...
:OSNoOK
	...
	echo       Ce programme supporte de Windows XP a 8.1 et necessite la presence de Powershell
